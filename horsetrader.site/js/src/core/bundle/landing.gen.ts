...
export const BAKED_EXTENT: { readonly start: CalendarDate; readonly end: CalendarDate } = {
  ...
  end: "2029-04-26" as CalendarDate,
};
...
export const BAKED_SCENARIOS: readonly { readonly start: CalendarDate; readonly image: string }[] = [
  ...
  { start: "2027-08-11" as CalendarDate, image: "/img/scenarios/scenario-07.webp" },
  { start: "2027-11-04" as CalendarDate, image: "/img/scenarios/scenario-08.webp" },
  { start: "2028-02-02" as CalendarDate, image: "/img/scenarios/scenario-09.webp" },
  { start: "2028-04-26" as CalendarDate, image: "/img/scenarios/scenario-10.webp" },
