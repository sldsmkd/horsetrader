...
/** One minimap banner marker — its date, kind (→ row/colour), and state glyph. */
...
/**
 * The banner appearances to plot as minimap markers. Bookmarks are the
 * **list-twin of the bookmarks drawer**: a banner is bookmarked when any of its
 * atom ids is favourited. Commitments are banner-keyed. Both are future-only
 * navigation hints at the banner appearance date (`start`). If both apply to the
 * same banner, commitment wins: the filled square is the stronger planning signal.
 */
