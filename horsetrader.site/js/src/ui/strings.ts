import type { LegendRaceKey } from "./identity/playStyleSettings.ts";
import type { PlayStyleKey } from "./views/playStylePreset.ts";

export type AssumptionStringKey =
  | "baselineEngagement"
  | "teamTrials"
  | "rotatingMissions"
  | "specialMissions"
...
export interface PlayStylePresetStrings {
  ...
  archetype: string;
  shape: string;
  assumptions: Record<AssumptionStringKey, string>;
}

export interface LegendRaceStepStrings {
  value: string;
  description: string;
}
...
export interface PlayStyleStrings {
  ...
  customPreset: string;
  apply: string;
  lockedAssumption: string;
  editableAssumption: string;
  customLockedTitle: string;
  presets: Record<PlayStyleKey, PlayStylePresetStrings>;
  assumptionLabels: Record<AssumptionStringKey, string>;
  legendRaces: {
    title: string;
    steps: Record<LegendRaceKey, LegendRaceStepStrings>;
  };
}
...
export const FALLBACK_STRINGS: UiStrings = {
  playStyle: {
    title: "Play Style",
    lockedPreset: "Locked preset",
    customPreset: "Custom preset",
    apply: "Apply",
    lockedAssumption: "Locked",
    editableAssumption: "Editable",
    ...
    presets: {
      sweetie: {
        ...
        assumptions: {
          baselineEngagement: "2 of 7 days",
          teamTrials: "Rank 4",
          rotatingMissions: "0%",
          specialMissions: "60%",
          storyEvents: "Story",
          championsMeeting: "Skips or does not finish",
        },
      },
      casual: {
        name: "Casual",
        ...
        assumptions: {
          baselineEngagement: "4 of 7 days",
          teamTrials: "Rank 5",
          rotatingMissions: "20%",
          specialMissions: "80%",
          storyEvents: "Welfare card",
          championsMeeting: "Group B contender",
        },
      },
      focused: {
        name: "Focused",
        ...
        assumptions: {
          baselineEngagement: "6 of 7 days",
          teamTrials: "Rank 5.5 promote-demote",
          rotatingMissions: "70%",
          specialMissions: "90%",
          storyEvents: "Major rewards",
          championsMeeting: "Group B winner",
        },
      },
      dedicated: {
        name: "Dedicated",
        ...
        assumptions: {
          baselineEngagement: "7 of 7 days",
          teamTrials: "Rank 6",
          rotatingMissions: "100%",
          specialMissions: "100%",
          storyEvents: "Achievement / stretch",
          championsMeeting: "Group A runner-up",
        },
      },
      unhinged: {
        name: "Unhinged",
        ...
        assumptions: {
          ...
          rotatingMissions: "100%",
          specialMissions: "100%",
          storyEvents: "Achievement / stretch, early",
          championsMeeting: "Group A champion",
        },
      },
      custom: {
        name: "Custom",
        ...
        assumptions: {
          baselineEngagement: "Custom",
          teamTrials: "Custom",
          rotatingMissions: "Custom",
          specialMissions: "Custom",
          storyEvents: "Custom",
          championsMeeting: "Custom",
        },
      },
    },
    assumptionLabels: {
      baselineEngagement: "Baseline engagement",
      teamTrials: "Team Trials",
      rotatingMissions: "Rotating missions",
